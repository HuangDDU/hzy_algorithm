...
if __name__=="__main__":
    ...
    while True:
        ...
        log_node_list(timestamp, node_list, pod_list, log_file="best_fit_01_head100.log") # 日志输出，用作可视化
        # log_node_list(timestamp, node_list, pod_list, log_file="best_fit_02_head100.log") # 日志输出，用作可视化
