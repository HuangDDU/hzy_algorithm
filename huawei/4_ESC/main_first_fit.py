    ...
    while True:
        ...
        if request_type == "CREATE":
            ...
            for i in range(S):
                ...
                pod_list.append(pod)
                # TODO: pod调度算法——首次适应（First Fit）(寻找能满足要求)，选择节点
                best_node = None
                ...
                if not best_node == None:
                    ...
                    best_node.placed_pod_id_list.append(pod.pod_id)
                    # node减少资源
                    ...
                    node.placed_pod_id_list.append(pod.pod_id)
                    # node减少资源
            ...
            # 对应END，结束跳出循环
            break
        log_node_list(timestamp, node_list, pod_list) # 日志输出，用作可视化
    sys.stdout.flush()